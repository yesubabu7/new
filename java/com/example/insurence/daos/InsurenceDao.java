...
import com.example.insurence.rowmappers.ClaimBillsRowMapper;
...
import com.example.insurence.rowmappers.ReUploadRowMapper;
import com.example.insurence.rowmappers.UploadsRowMapper;
...
public class InsurenceDao implements DaoInterface {
	...
	private String SQL_GET_CLAIM_BY_ID = "select * from  _Claims where clam_iplc_id=?";
